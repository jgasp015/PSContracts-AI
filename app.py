...
# --- 0. PAGE CONFIG ---
st.set_page_config(page_title="Public Sector Contracts AI", page_icon="📜")
...
def scrape_agency_bids(url):
    guidance = ["⚠️ **Dynamic Portal Detected.**", "➡️ **Instruction:** Download the PDF and upload to 'Bid Document'."]
    url_lower = url.lower()
